...
(:: import schema at "../WSDL/CustomerAccountService.wsdl" ::)
declare namespace ns1="urn:xyzbank:cust:schema:customer";
(:: import schema at "../WSDL/CustomerService.wsdl" ::)
declare namespace ns2="urn:xyzbank:cust:schema:order";
(:: import schema at "../WSDL/CustomerOrderService.wsdl" ::)
...
declare function local:getCustomerInfo($varCustomer as element() (:: schema-element(ns1:customer) ::), 
    ...
    <ns1:migrated_customer>
        ...
        <customer_accounts>
          <account>
              {
                  if ($varAccount/ns3:account_id)
                  then <account_id>{fn:data($varAccount/ns3:account_id)}</account_id>
                  else ()
              }
              {
